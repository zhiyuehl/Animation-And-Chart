...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.type & kFillWave) {
        ...
        [self.drawRectObject useDrawingStyle:_fillStyle drawFillBlock:^(DrawRectObject *drawRectObject) {
            ...
            if (self.direction == EWaveViewDown) {
                [drawRectObject addLineToPoint:CGPointMake(width, 0)];
                [drawRectObject addLineToPoint:CGPointMake(0, 0)];
