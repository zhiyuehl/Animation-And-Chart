//
//  LinerCollectionViewController.m
//  AnimationDemo
//
...
#import "LinerCollectionViewController.h"
#import "AnimationDemo-Swift.h"
#import "TestPageViewCell.h"

@interface LinerCollectionViewController ()
...
@implementation LinerCollectionViewController
...
- (void)viewDidLoad
{
    ...
    [self.pagerView registerClass:[TestPageViewCell class] forCellWithReuseIdentifier:@"TestPageViewCell"];
...
{
    TestPageViewCell * cell = (TestPageViewCell *)[pagerView dequeueReusableCellWithReuseIdentifier:@"TestPageViewCell" atIndex:index];
...
//    self.pagerView.transformer.minimumScale = 0.7;
    switch (type) {
